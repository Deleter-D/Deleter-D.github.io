...
![](https://cdn.jsdelivr.net/gh/Deleter-D/mycdn/blog-image/202205181634584.png)
...
![](https://cdn.jsdelivr.net/gh/Deleter-D/mycdn/blog-image/202205181516263.png)
...
![](https://cdn.jsdelivr.net/gh/Deleter-D/mycdn/blog-image/202205181529014.png)
...
![](https://cdn.jsdelivr.net/gh/Deleter-D/mycdn/blog-image/202205181545554.png)
...
![](https://cdn.jsdelivr.net/gh/Deleter-D/mycdn/blog-image/202205181552668.png)

但该方案有一个严重且隐蔽的问题：

假设有两个垃圾回收线程`m1`、`m2`，一个业务线程`t1`。开始时m1将A及其的孩子1标记，则此时在m1视角中A是灰色的；

![](https://cdn.jsdelivr.net/gh/Deleter-D/mycdn/blog-image/202205181559428.png)

此时发生了情况二，即B->C消失了，但增加了A->C，则通过写屏障将A标记为灰色（A此时本来就是灰色）；

![](https://cdn.jsdelivr.net/gh/Deleter-D/mycdn/blog-image/202205181603893.png)

然后m1回来继续工作，此时m1的视角下，A是灰色，但它只直到A的孩子2还没有标记，故m1将孩子2标记，此时对于m1来说，A的所有孩子已经标记完成，故会将A标记为黑色，此时出现了漏标C的情况。

![](https://cdn.jsdelivr.net/gh/Deleter-D/mycdn/blog-image/202205181607612.png)
...
![](https://cdn.jsdelivr.net/gh/Deleter-D/mycdn/blog-image/202205181620470.png)
